...
<div class="header">
    ...
    <div class="info">
        <div class="app-text">
            <h3>This website creat for something</h3>
            <p>This site was created as part of the laboratory <br> work on the course WEB</p>
            <p>Maybe someday it will grow into something <br>more than just laboratory work, maybe ...</p>
            <p>I wonder how many will remain in 3151 people <br> in the fourth year of the university?</p>
            <p>It was cool before the war and quarantine <br> in the first year of university, it was ....</p>
            <p>Okay, it's 4 in the morning, it's time for bed.</p>
